...
export default function Home() {
  ...
  return (
    <main>
      <section className="relative mb-14 overflow-hidden bg-gradient-to-br from-pink-500 via-pink-500 to-pink-600">
        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-14 pt-8 sm:px-6 sm:pb-20 sm:pt-10">
          ...
          <h1 className="mt-4 max-w-xl font-display text-4xl font-bold leading-tight text-white sm:text-5xl">
          ...
          <div className="mt-7 flex max-w-2xl flex-col gap-2 rounded-2xl bg-white p-2 shadow-xl sm:flex-row sm:items-center sm:gap-0 sm:rounded-full">
            <div className="flex items-center gap-2 px-3 py-2.5 sm:w-[38%] sm:border-r sm:border-ink-100">
